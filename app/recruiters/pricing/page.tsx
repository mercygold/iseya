...
export default function RecruiterPricingPage() {
  return (
    <Suspense fallback={<RecruiterPricingLoading />}>
      <RecruiterPricingContent />
    </Suspense>
  );
}

function RecruiterPricingLoading() {
  return (
    <RecruiterShell>
      <section className="mx-auto max-w-[92rem] px-5 py-10 sm:px-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm font-semibold text-[var(--iseya-navy)]">Loading recruiter plans...</p>
        </div>
      </section>
    </RecruiterShell>
  );
...
function RecruiterPricingContent() {
